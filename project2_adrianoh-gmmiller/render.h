...
float findIntersectionTimestep(vector s, vector e);

pixel findIntersectingPixel(int height, int width, vector s, vector e);

void setPixel(float *img, int width, int x, int y, float red,
